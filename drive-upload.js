...
function _getDriveAccessToken() {
  return new Promise((resolve, reject) => {
    ...
    client.error_callback = (err) => reject(new Error(err.message || "Google sign-in was cancelled or blocked."));
